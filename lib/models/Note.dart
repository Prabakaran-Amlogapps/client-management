...
class Note extends amplify_core.Model {
  ...
  const Note._internal({required this.id, required title, description, required isCompleted, createdAt, updatedAt}): _title = title, _description = description, _isCompleted = isCompleted, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Note({String? id, required String title, String? description, required bool isCompleted, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
  ...
  Note copyWith({String? title, String? description, bool? isCompleted, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt}) {
    return Note._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'description': _description, 'isCompleted': _isCompleted, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
