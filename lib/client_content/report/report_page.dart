...
class client_reportpage extends StatefulWidget {
  const client_reportpage({super.key});

  @override
  State<client_reportpage> createState() => _client_reportpageState();
}

class _client_reportpageState extends State<client_reportpage> {
              ...
              _buildSectionCard(
                ...
                child: Column(
                  children: [
                    ...
                    _buildAnimatedCheckboxTile(
                      title: 'Project List',
                      subtitle: 'Project list and payment details',
                      icon: Icons.payments,
                    ...
                    _buildAnimatedCheckboxTile(
                      ...
                      subtitle: 'payment pendings and time-off details',
                      icon: Icons.person,
                      value: _leaveChecked,
                      onChanged: (value) {
